...
namespace BlazorAppAuth.DAL.Repositories
{
    public class ProductRepository : IProductRepository
    {
        private readonly BlazorAppAuthContext shopOnlineDbContext;
        ...
        {  
           //Retrive Product and Category with one trip by using 'Include'
